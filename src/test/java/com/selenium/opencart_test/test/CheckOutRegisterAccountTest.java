...
public class CheckOutRegisterAccountTest {
	...
	public void testRegisterAccountBoundary() {
	    ...
	    String firstName = "AlexandriaCatherineElizabethMarieAnn"; // Họ tên lớn hơn giới hạn
	    String lastName = "MontgomeryWilliamsonMacAllisterBrown"; // Họ tên lớn hơn giới hạn
	    String email = "sdnkkdsfk"; // Email không hợp lệ
	    String company = "Company ABC";
	    String address1 = "234 Elm Street, Apartment 56B, Greenfield, Ho Chi Minh City, Vietnam, 700000, Near Central Park, District 1"; // Địa chỉ lớn hơn giới hạn
	    String address2 = "Quan 5";
	    String city = "Ho Chi Minh City, a bustling metropolis in southern Vietnam known for its vibrant culture, delicious street food, and historical landmarks"; // Thành phố lớn hơn giới hạn
	    String postCode = "700000";
	    String country = " --- Please Select --- ";
	    String region = "--- Please Select --- ";
	    String password = "ThisIsAStrongPassw0rd!"; // Mật khẩu hợp lệ
	...
	public void testRegisterAccountAboveLowerBoundary() {
	    ...
	    String firstName = "AC"; // Tên dài hơn giới hạn tối thiểu
	    String lastName = "BC"; // Họ dài hơn giới hạn tối thiểu
	    String email = "sdnkkdsfk"; // Email không hợp lệ
	    String company = "Company ABC";
	    String address1 = "Q.12"; // Địa chỉ dài hơn giới hạn tối thiểu
	    String address2 = "Quan 5";
	    String city = "SG."; // Tên thành phố dài hơn giới hạn tối thiểu
	    String postCode = "700000";
	    String country = " --- Please Select --- ";
	    String region = "--- Please Select --- ";
	    String password = "12345"; // Mật khẩu dài hơn giới hạn tối thiểu
